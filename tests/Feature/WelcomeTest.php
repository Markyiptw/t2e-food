...
class WelcomeTest extends TestCase
{
    ...
    public function test_form_renders(): void
    {
        ...
        $response->assertSee('eating out at', false);
        ...
        $response->assertSee('value="02:00" selected', false);
        $response->assertSee('value="05:00">', false);
    ...
    public function test_data_section_heading_renders(): void
    {
        $response = $this->get('/');

        $response->assertSee('We take care of the data', false);
    }
    ...
    public function test_footer_renders(): void
    {
        ...
        $response->assertSee(date('Y'), false);
        $response->assertSee('MIT License', false);
    }
}
